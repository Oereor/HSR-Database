...
const requiredFiles = [
  ...
  'ExcelOutput/RogueBuff.json',
  'ExcelOutput/RogueBuffGroup.json',
  'ExcelOutput/RogueBuffType.json',
  'ExcelOutput/RogueTournBuff.json',
  'ExcelOutput/RogueTournBuffGroup.json',
  'ExcelOutput/RogueTournBuffType.json',
  'ExcelOutput/RogueAeon.json',
  'ExcelOutput/RogueDLCAeon.json',
  'ExcelOutput/RogueNousAeon.json',
  'ExcelOutput/RogueDLCAeonCross.json',
  'ExcelOutput/RogueNousAeonCross.json',
  'ExcelOutput/RogueTournFormula.json',
  'ExcelOutput/RogueTournFormulaDisplay.json',
